...
$mvt.XP = function(d) {
    ...
    f.Xs = function(s, n, h, t, i, u) {
        ...
        if (j[1] < 500 || i) {
            ...
            var p = $mvt.hI.cookie,
            o = $mvt.R(window.location.href, "_mvosr=", "&");
...
$mvt.xO.xS.prototype.HS = function() {
    var e = this;
    var d = [],
    a = [["jzqsr=", e.lb], ["jzqct=", e.lB.substr(0, 100)]],
    c,
    b;
    if (e.xu()) {
        for (c = 0; c < a[$mvt.X]; c++) {
