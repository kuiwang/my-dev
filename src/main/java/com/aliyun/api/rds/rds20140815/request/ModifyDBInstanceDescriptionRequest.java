...
import com.aliyun.api.rds.rds20140815.response.ModifyDBInstanceDescriptionResponse;
...
public class ModifyDBInstanceDescriptionRequest
    ...
    public void check() throws ApiRuleException {
        RequestCheckUtils.checkNotEmpty(dBInstanceDescription, "dBInstanceDescription");
