...
import com.aliyun.api.rds.rds20140815.response.ModifyDBDescriptionResponse;
 ...
 */
public class ModifyDBDescriptionRequest implements AliyunRequest<ModifyDBDescriptionResponse> {
    ...
    public void check() throws ApiRuleException {
        RequestCheckUtils.checkNotEmpty(dBDescription, "dBDescription");
