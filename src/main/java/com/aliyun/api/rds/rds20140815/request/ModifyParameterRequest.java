...
import com.aliyun.api.rds.rds20140815.response.ModifyParameterResponse;
 ...
 */
public class ModifyParameterRequest implements AliyunRequest<ModifyParameterResponse> {
    ...
    /**
     * 参数及其值的JSON串， 参数的值都是字符串类型， {"auto_increment_increment":"1",
    ...
    public Map<String, String> getTextParams() {
        ...
        txtParams.put("Forcerestart", this.forcerestart);
