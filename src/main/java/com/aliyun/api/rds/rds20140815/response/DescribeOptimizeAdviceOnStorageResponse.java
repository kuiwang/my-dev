...
import com.aliyun.api.domain.AdviceOnStorage;
import com.taobao.api.internal.mapping.ApiField;
import com.taobao.api.internal.mapping.ApiListField;

/**
 * TOP API: rds.aliyuncs.com.DescribeOptimizeAdviceOnStorage.2014-08-15
 * response.
 * 
 * @author auto create
 * @since 1.0, null
 */
public class DescribeOptimizeAdviceOnStorageResponse extends AliyunResponse {

    private static final long serialVersionUID = 5283846887895112484L;

    /**
     * AdviceOnStorage列表
     */
    @ApiListField("Items")
    @ApiField("AdviceOnStorage")
