...
import com.aliyun.api.domain.AdviceOnMissIndex;
 ...
 * @since 1.0, null
 */
public class DescribeOptimizeAdviceOnMissIndexResponse extends AliyunResponse {

    private static final long serialVersionUID = 8118432841882148711L;

    /**
     * AdviceOnMissIndex列表
     */
    @ApiListField("Items")
    @ApiField("AdviceOnMissIndex")
