...
import com.aliyun.api.ecs.ecs20130110.response.DescribeInstanceDisksResponse;
 ...
 */
public class DescribeInstanceDisksRequest implements AliyunRequest<DescribeInstanceDisksResponse> {
    ...
    @Override
    public Class<DescribeInstanceDisksResponse> getResponseClass() {
        return DescribeInstanceDisksResponse.class;
    }
