...
/**
 * TOP API: ecs.aliyuncs.com.AssociateEipAddress.2014-05-26 request
 * 
 * @author auto create
 * @since 1.0, 2014-11-02 16:51:33
 */
public class AssociateEipAddressRequest implements AliyunRequest<AssociateEipAddressResponse> {
