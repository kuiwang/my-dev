...
import com.aliyun.api.mts.mts20140618.response.QueryVideoListByIdsResponse;
 ...
 */
public class QueryVideoListByIdsRequest implements AliyunRequest<QueryVideoListByIdsResponse> {
    ...
    @Override
    public Class<QueryVideoListByIdsResponse> getResponseClass() {
        return QueryVideoListByIdsResponse.class;
    }
