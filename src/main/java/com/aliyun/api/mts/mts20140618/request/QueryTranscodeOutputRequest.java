...
import com.aliyun.api.mts.mts20140618.response.QueryTranscodeOutputResponse;
 ...
 */
public class QueryTranscodeOutputRequest implements AliyunRequest<QueryTranscodeOutputResponse> {
    ...
    public Map<String, String> getTextParams() {
        ...
        txtParams.put("TemplateIds", this.templateIds);
    ...
    public Class<QueryTranscodeOutputResponse> getResponseClass() {
        return QueryTranscodeOutputResponse.class;
    }
