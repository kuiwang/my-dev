...
import com.aliyun.api.mts.mts20140618.response.QueryVideoByIdResponse;
 ...
 */
public class QueryVideoByIdRequest implements AliyunRequest<QueryVideoByIdResponse> {
    ...
    @Override
    public Class<QueryVideoByIdResponse> getResponseClass() {
        return QueryVideoByIdResponse.class;
    }
