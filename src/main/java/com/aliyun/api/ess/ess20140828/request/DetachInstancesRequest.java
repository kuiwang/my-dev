...
import com.aliyun.api.ess.ess20140828.response.DetachInstancesResponse;
import com.taobao.api.ApiRuleException;
import com.taobao.api.internal.util.RequestCheckUtils;
import com.taobao.api.internal.util.TaobaoHashMap;

/**
 * TOP API: ess.aliyuncs.com.DetachInstances.2014-08-28 request
 * 
 * @author auto create
 * @since 1.0, 2014-11-02 16:51:41
 */
public class DetachInstancesRequest implements AliyunRequest<DetachInstancesResponse> {
    ...
    public void check() throws ApiRuleException {
        RequestCheckUtils.checkNotEmpty(instanceId1, "instanceId1");
