...
public abstract class RemotingServerChannelHandler extends SimpleChannelHandler {
    ...
    private void onMessage(final ChannelContext context, Object msg) throws ChannelException,
        ...
        if (this.threadPool == null) {
            this.internalOnMessage(context, callContext, protocol, operation, transportHeaders,
                    serializer);
            return;
        }
        ...
        try {
            this.threadPool.execute(new Runnable() {
                ...
                public void run() {
                    try {
                        internalOnMessage(context, callContext, protocol, operation,
                                transportHeaders, serializer);
