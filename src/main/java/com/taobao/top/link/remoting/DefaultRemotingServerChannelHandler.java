...
public class DefaultRemotingServerChannelHandler extends RemotingServerChannelHandler {
    ...
    @Override
    public final MethodReturn onMethodCall(MethodCall methodCall, MethodCallContext callContext)
            throws Throwable {
        ...
        if (processor == null) throw new NullPointerException(String.format(
