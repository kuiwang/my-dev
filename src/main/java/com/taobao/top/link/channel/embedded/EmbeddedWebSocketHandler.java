...
public class EmbeddedWebSocketHandler implements WebSocketHandler {
    ...
    public EmbeddedWebSocketHandler(Logger logger, EmbeddedWebSocketClientChannel clientChannel) {
        this.logger = logger;
    ...
    public void onError(WebSocket socket, WebSocketException e) {
        if (this.clientChannel != null) this.clientChannel.error = e;
        if (this.haveHandler()) {
            try {
