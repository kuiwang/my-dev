...
public class LogisticsTraceSearchResponse extends TaobaoResponse {
    ...
    private static final long serialVersionUID = 5556146531853341918L;
    ...
    /**
     * 订单的物流状态（仅支持线上发货online订单，线下发货offline发出后直接变为已签收） 等候发送给物流公司
     * 已提交给物流公司,等待物流公司接单 已经确认消息接收，等待物流公司接单 物流公司已接单 物流公司不接单 物流公司揽收失败
     * 物流公司揽收成功 签收失败 对方已签收 对方拒绝签收
     */
    @ApiField("status")
