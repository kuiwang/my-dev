...
/**
 * TOP API: taobao.inventory.adjust.trade response.
 * 
 * @author auto create
 * @since 1.0, null
 */
public class InventoryAdjustTradeResponse extends TaobaoResponse {

    private static final long serialVersionUID = 8415359897765738822L;
