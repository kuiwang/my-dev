...
/**
 * TOP API: alipay.point.order.get response.
 * 
 * @author auto create
 * @since 1.0, null
 */
public class AlipayPointOrderGetResponse extends TaobaoResponse {

    private static final long serialVersionUID = 7156647757458856716L;
    ...
    /**
     * isv提供的发放号订单号，由数字和字母组成，最大长度为32为，需要保证每笔发放的唯一性，支付宝会对该参数做唯一性控制。
     * 如果使用同样的订单号，支付宝将返回订单号已经存在的错误
     */
