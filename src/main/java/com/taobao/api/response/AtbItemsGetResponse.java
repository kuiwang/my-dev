...
/**
 * TOP API: taobao.atb.items.get response.
 * 
 * @author auto create
 * @since 1.0, null
 */
public class AtbItemsGetResponse extends TaobaoResponse {

    private static final long serialVersionUID = 4162681561767369198L;
