...
public class TraderatesGetResponse extends TaobaoResponse {
    ...
    private static final long serialVersionUID = 6191613522335422639L;
    ...
    /**
     * 搜索到的评价总数。相同的查询时间段条件下，最大只能获取总共1500条评价记录。所以当评价大于等于1500时
     * ISV可以通过start_date及end_date来进行拆分，以保证可以查询到全部数据
     */
