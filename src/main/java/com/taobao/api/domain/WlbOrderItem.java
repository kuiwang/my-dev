...
public class WlbOrderItem extends TaobaoObject {
    ...
    private static final long serialVersionUID = 3615615894721139283L;
    ...
    /**
     * INVENTORY_TYPE_SELL 可销库存 INVENTORY_TYPE_IMPERFECTIONS 残次库存
     * INVENTORY_TYPE_FREEZE 冻结库存 INVENTORY_TYPE_ON_PASSAGE 在途库存
     * INVENTORY_TYPE_ENGINE_DAMAGE 机损 INVENTORY_TYPE_BOX_DAMAGE 箱损
     */
    ...
    /**
     * (1)其它: OTHER (2)淘宝交易: TAOBAO (3)调拨: ALLOCATION (4)盘点:CHECK
     * (5)销售采购:PRUCHASE(6)其它交易：OTHER_TRADE
     */
