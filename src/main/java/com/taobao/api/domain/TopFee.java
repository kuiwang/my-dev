...
public class TopFee extends TaobaoObject {
    ...
    private static final long serialVersionUID = 3519681882534466666L;
    ...
    /**
     * 邮费子项涉及的地区,多个地区用逗号连接数量串;可以用taobao.areas.get接口获取.或者参考:http://www.stats
     * .gov.cn/tjbz/xzqhdm/t20080215_402462675.htm 例
     * (110000,310000,320000,330000).就代表邮费子项涉
