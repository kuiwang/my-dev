...
public class DealerOrder extends TaobaoObject {
    ...
    private static final long serialVersionUID = 4866878618378786794L;
     ...
     * WAIT_FOR_APPLIER_STORAGE：供应商发货，待分销商收货； TRADE_FINISHED：分销商收货，交易成功；
    ...
    /**
     * 支付方式： ALIPAY_SURETY（支付宝担保交易） TRANSFER（线下转账） PREPAY（预存款）
     * IMMEDIATELY（即时到账）
     */
    @ApiField("pay_type")
