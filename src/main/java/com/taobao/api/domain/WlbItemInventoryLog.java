...
public class WlbItemInventoryLog extends TaobaoObject {
    ...
    private static final long serialVersionUID = 5273517391468381286L;
    ...
    /**
     * VENDIBLE 1-可销售; FREEZE 201-冻结库存; ONWAY 301-在途库存; DEFECT 101-残存品;
     * ENGINE_DAMAGE 102-机损; BOX_DAMAGE 103-箱损
     */
    ...
    /**
     * 库存操作作类型 CHU_KU 1-出库 RU_KU 2-入库 FREEZE 3-冻结 THAW 4-解冻 CHECK_FREEZE
     * 5-冻结确认 CHANGE_KU 6-库存类型变更
     */
    @ApiField("op_type")
