...
public class WlbOrder extends TaobaoObject {
    ...
    private static final long serialVersionUID = 7388582334216412724L;
    ...
    /**
     * 第1位:COD,2:限时配送,3:预售,4:需要发票,5:已投诉,第6位:合单,第7位:拆单 第8位：EXCHANGE-换货，
     * 第9位:VISIT-上门 ， 第10位: MODIFYTRANSPORT-是否可改配送方式，第11位：是否物流代理确认发货
     */
    @ApiField("order_flag")
    ...
    /**
     * 物流状态， 订单已创建：0 订单已取消: -1 订单关闭:-3 下发中: 10 已下发: 11 接收方拒签 :-100 已发货:100
     * 签收成功:200
     */
    ...
    /**
     * (1)其它: OTHER (2)淘宝交易: TAOBAO (3)301:调拨: ALLOCATION (4)401:盘点:CHECK
     * (5)501:销售采购:PRUCHASE
     */
