...
public class Refund extends TaobaoObject {
    ...
    private static final long serialVersionUID = 5747296816946222194L;
    ...
    /**
     * 退款先行垫付默认的未申请状态 0;退款先行垫付申请中 1;退款先行垫付，垫付完成 2;退款先行垫付，卖家拒绝收货
     * 3;退款先行垫付，垫付关闭 4;退款先行垫付，垫付分账成功 5;
     */
    ...
    /**
     * 货物状态。可选值BUYER_NOT_RECEIVED (买家未收到货) BUYER_RECEIVED (买家已收到货)
    ...
    /**
     * 退款对应的订单交易状态。可选值TRADE_NO_CREATE_PAY(没有创建支付宝交易) WAIT_BUYER_PAY(等待买家付款)
     ...
     * ALL_CLOSED(包含：TRADE_CLOSED、TRADE_CLOSED_BY_TAOBAO) 取自
     * "http://open.taobao.com/dev/index.php/%E4%BA%A4%E6%98%93%E7%8A%B6%E6%80%81"
     */
