...
public class Product extends TaobaoObject {
    ...
    private static final long serialVersionUID = 7841589838126291356L;
    ...
    /**
     * 标识是否为达尔文体系下的产品 。 如果为空表示是非达尔文体系下的产品 如果cspu:0
     * 表示是达尔文体系下的产品，有cspu正在待小二审核，但不能发布商品。 如果cspu:1
     * 表示是达尔文体系下的产品，且有小二确认的cspu，能发布商品
     */
    ...
    /**
     * 产品的子图片.目前最多支持4张。fields中设置为product_imgs.id、product_imgs.url、
     * product_imgs.position 等形式就会返回相应的字段
     */
     ...
     * product_prop_imgs .props、product_prop_imgs.url、product_prop_imgs.
     * position等形式就会返回相应的字段
     */
