...
public class SuiteConfDO extends TaobaoObject {
    ...
    private static final long serialVersionUID = 1633815819595593647L;
    ...
    /**
     * 套装，子规格限制数，当前一级类目，最多允许选择多少个产品规格，为空表示无限制。套装子规格形如:A*n,B*n,C*n....,
     * max_size就是C的最大个数
     */
    @ApiField("max_size")
    ...
    /**
     * 套装，子规格数量总和限制，当前一级类目，所以子产品规格的数量不能超过这个值，为空表示无限制,套装子规格形如：A*n,B*n,C*n...
     * .,max_total_number就是所有n和的最大限制
     */
    ...
    /**
     * 套装类目ID，当前一级类目，如果发布跨叶子类目的的套装，默认放到那个类目。如果没有值表示root_cat_id类目下发布的套装产品，
     * 不支持跨类目
     */
