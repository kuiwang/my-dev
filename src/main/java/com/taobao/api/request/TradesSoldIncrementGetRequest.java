...
public class TradesSoldIncrementGetRequest implements TaobaoRequest<TradesSoldIncrementGetResponse> {
     ...
     * type, created, tid, seller_rate,seller_can_rate,
     * buyer_rate,can_rate,status, payment, discount_fee, adjust_fee,
     * post_fee, total_fee, pay_time, end_time, modified, consign_time,
     * buyer_obtain_point_fee, point_fee, real_point_fee,
     * received_payment,pic_path, num_iid, num, price, cod_fee, cod_status,
     * shipping_type, receiver_name, receiver_state, receiver_city,
     * receiver_district, receiver_address, receiver_zip, receiver_mobile,
     * receiver_phone
     * ,alipay_id,alipay_no,is_lgtype,is_force_wlb,is_brand_sale
     * ,has_buyer_message
     * ,credit_card_fee,step_trade_status,step_paid_fee,mark_desc
     * ,send_time,
     * ,has_yfx,yfx_fee,yfx_id,yfx_type,trade_source,seller_flag,
     * is_daixiao,is_part_consign,zero_purchase 2.Order中可以指定返回fields：
     ...
     * orders.seller_type
     * ，orders.end_time,,orders.consign_time,orders.shipping_type
     * ,orders.logistics_company,orders.invoice_no,orders.is_daixiao
     ...
     * o2o_offlinetrade（O2O交易） nopaid（即时到帐/趣味猜交易类型） eticket(电子凭证)
