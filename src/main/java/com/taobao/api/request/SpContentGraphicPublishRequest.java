...
import com.taobao.api.response.SpContentGraphicPublishResponse;
 ...
 */
public class SpContentGraphicPublishRequest
        implements TaobaoRequest<SpContentGraphicPublishResponse> {
