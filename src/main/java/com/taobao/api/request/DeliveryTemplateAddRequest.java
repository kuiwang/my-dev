...
public class DeliveryTemplateAddRequest implements TaobaoRequest<DeliveryTemplateAddResponse> {
     ...
     * <br/>
     * <br/>
     * <font color=blue>增费必须小于等于首费，但是当首费为0时增费可以大于首费</font>
     * 
     * 
     * <br/>
     * <br/>
     ...
     * (ems),货到付款(cod),物流宝保障速递(wlb),家装物流(furniture
     * )结构:value1;value2;value3;value4 如: post;express;ems;cod <br/>
     ...
     * 5、由于3和4的原因所以当是货到付款用户或保障速递用户时如果没填写对应的运送方式express是必须填写的 </font>
     */
