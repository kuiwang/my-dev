...
import com.taobao.api.response.CrmGrademktMemberDetailQueryResponse;
 ...
 */
public class CrmGrademktMemberDetailQueryRequest implements
        TaobaoRequest<CrmGrademktMemberDetailQueryResponse> {
    ...
    @Override
    public Class<CrmGrademktMemberDetailQueryResponse> getResponseClass() {
        return CrmGrademktMemberDetailQueryResponse.class;
    }
