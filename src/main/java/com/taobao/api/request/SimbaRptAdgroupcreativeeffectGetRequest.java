...
import com.taobao.api.response.SimbaRptAdgroupcreativeeffectGetResponse;
 ...
 */
public class SimbaRptAdgroupcreativeeffectGetRequest implements
        TaobaoRequest<SimbaRptAdgroupcreativeeffectGetResponse> {
    ...
    @Override
    public Class<SimbaRptAdgroupcreativeeffectGetResponse> getResponseClass() {
        return SimbaRptAdgroupcreativeeffectGetResponse.class;
    }
