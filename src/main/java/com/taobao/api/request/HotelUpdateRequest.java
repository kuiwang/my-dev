...
public class HotelUpdateRequest implements TaobaoUploadRequest<HotelUpdateResponse> {
     ...
     * domestic为false时，传海外国家编码。参见：http://kezhan.trip
     * .taobao.com/countrys.html
     */
     ...
     * ：中餐厅，westernRestaurant：西餐厅，cafe：咖啡厅，bar：酒吧，ktv：KTV。 如：
     * {"airportShuttle"
     * :true,"parking":false,"fitnessClub":false,"chineseRestaurant"
     * :false,"rentCar"
     * :false,"laundry":false,"bankCard":false,"cityCenterDistance"
     * :-1,"creditCard"
     * :false,"westernRestaurant":false,"ktv":false,"railwayDistance"
     * :-1,"swimmingPool"
     * :false,"cafe":false,"businessCenter":false,"morningCall"
