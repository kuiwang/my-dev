...
import com.taobao.api.response.SimbaRptAdgroupkeywordeffectGetResponse;
 ...
 */
public class SimbaRptAdgroupkeywordeffectGetRequest implements
        TaobaoRequest<SimbaRptAdgroupkeywordeffectGetResponse> {
    ...
    @Override
    public Class<SimbaRptAdgroupkeywordeffectGetResponse> getResponseClass() {
        return SimbaRptAdgroupkeywordeffectGetResponse.class;
    }
