...
import com.taobao.api.response.WeitaoCloudtagsTagsGetResponse;
...
public class WeitaoCloudtagsTagsGetRequest implements TaobaoRequest<WeitaoCloudtagsTagsGetResponse> {
    ...
    public Class<WeitaoCloudtagsTagsGetResponse> getResponseClass() {
        return WeitaoCloudtagsTagsGetResponse.class;
    }
