...
import com.taobao.api.response.SimbaInsightWordspricedataGetResponse;
 ...
 */
public class SimbaInsightWordspricedataGetRequest
        implements TaobaoRequest<SimbaInsightWordspricedataGetResponse> {
