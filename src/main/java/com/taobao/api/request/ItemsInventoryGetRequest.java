...
public class ItemsInventoryGetRequest implements TaobaoRequest<ItemsInventoryGetResponse> {
     ...
     * modified,delist_time,postage_id,seller_cids,outer_id；字段之间用“,”分隔。<br>
    ...
    /**
     * 页码。取值范围:大于零小于等于101的整数;默认值为1，即返回第一页数据。当页码超过101页时系统就会报错，
     * 故请大家在用此接口获取数据时尽可能的细化自己的搜索条件，例如根据修改时间分段获取商品。<br />
     * 支持最大值为：101
     */
    private Long pageNo;
