...
import com.taobao.api.response.SpContentGetdetailbyidResponse;
...
public class SpContentGetdetailbyidRequest implements TaobaoRequest<SpContentGetdetailbyidResponse> {
    ...
    @Override
    public Class<SpContentGetdetailbyidResponse> getResponseClass() {
        return SpContentGetdetailbyidResponse.class;
    }
