...
import com.taobao.api.response.SimbaRptCampadgroupbaseGetResponse;
 ...
 */
public class SimbaRptCampadgroupbaseGetRequest implements
        TaobaoRequest<SimbaRptCampadgroupbaseGetResponse> {
    ...
    @Override
    public Class<SimbaRptCampadgroupbaseGetResponse> getResponseClass() {
        return SimbaRptCampadgroupbaseGetResponse.class;
    }
