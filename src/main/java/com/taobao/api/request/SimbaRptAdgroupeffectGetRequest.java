...
import com.taobao.api.response.SimbaRptAdgroupeffectGetResponse;
...
public class SimbaRptAdgroupeffectGetRequest
    ...
    @Override
    public Class<SimbaRptAdgroupeffectGetResponse> getResponseClass() {
        return SimbaRptAdgroupeffectGetResponse.class;
    }
