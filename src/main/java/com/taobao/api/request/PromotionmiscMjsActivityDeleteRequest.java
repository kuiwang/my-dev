 ...
 */
public class PromotionmiscMjsActivityDeleteRequest
        implements TaobaoRequest<PromotionmiscMjsActivityDeleteResponse> {
    ...
    @Override
    public Class<PromotionmiscMjsActivityDeleteResponse> getResponseClass() {
        return PromotionmiscMjsActivityDeleteResponse.class;
    }
