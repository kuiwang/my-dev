...
import com.taobao.api.response.SimbaRptAdgroupbaseGetResponse;
 ...
 */
public class SimbaRptAdgroupbaseGetRequest implements TaobaoRequest<SimbaRptAdgroupbaseGetResponse> {
    ...
    @Override
    public Class<SimbaRptAdgroupbaseGetResponse> getResponseClass() {
        return SimbaRptAdgroupbaseGetResponse.class;
    }
