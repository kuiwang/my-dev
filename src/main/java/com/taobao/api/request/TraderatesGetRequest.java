...
public class TraderatesGetRequest implements TaobaoRequest<TraderatesGetResponse> {
    ...
    /**
     * 评价者角色即评价的发起方。可选值:seller(卖家),buyer(买家)。 当 give buyer 以买家身份给卖家的评价； 当
     * get seller 以买家身份得到卖家给的评价； 当 give seller 以卖家身份给买家的评价； 当 get buyer
     * 以卖家身份得到买家给的评价。
     */
    private String role;
